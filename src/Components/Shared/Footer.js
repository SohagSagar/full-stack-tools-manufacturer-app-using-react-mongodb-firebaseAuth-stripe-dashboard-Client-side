...
const Footer = () => {
    return (
        <section className='lg:px-24 lg:py-6'>
            <footer class="footer text-base-content flex justify-between flex-wrap">
                <div>
            ...
            <div className='uppercase font-semibold text-accent lg:text-[12px] text-[px] flex items-center lg:justify-between sm:justify-center flex-col-reverse sm:flex-row-reverse '>
